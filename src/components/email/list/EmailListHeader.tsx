...
const ICON_BUTTON_CLASSES = "h-10 w-10 rounded-xl";
        ...
        {hasSelection ? (
            ...
            <DeleteDialog
              trigger={
                <Button
                  variant="ghost"
                  size="icon"
                  className={`${ICON_BUTTON_CLASSES} hover:bg-destructive/10 hover:text-destructive`}
          ...
          <>
            ...
            <Button
              ...
              onClick={onRefresh}
              disabled={loading}
              className={`${ICON_BUTTON_CLASSES} shadow-sm hover:shadow-md transition-all duration-200`}
            >
              <motion.div
